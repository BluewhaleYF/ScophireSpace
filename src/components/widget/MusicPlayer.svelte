<script lang="ts">
	...
	const localPlaylist = [
		{
			id: 1,
			title: "Geeklogic Theme",
			artist: "未来乐器研究所",
			cover: "assets/music/cover/GeekLogic Theme.png",
			url: "assets/music/url/Geeklogic Theme.m4a",
			duration: 128,
		},
		{
			id: 2,
			title: "Higher",
			artist: "Tobu",
			cover: "assets/music/cover/Higher.jpg",
			url: "assets/music/url/Higher.mp3",
			duration: 213,
		},
		{
			id: 3,
			title: "WindowsXP title",
			artist: "Microsoft Windows",
			cover: "assets/music/cover/WindowsXP-title.png",
			url: "assets/music/url/WindowsXP-title.m4a",
			duration: 372,
		},
	];
